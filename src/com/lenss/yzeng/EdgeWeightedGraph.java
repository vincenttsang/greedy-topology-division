...
public class EdgeWeightedGraph {
    ...
    public EdgeWeightedGraph(In in) {
        ...
        for (int i = 0; i < E; i++) {
            ...
            Edge e = new Edge(v, w, weight);
            addEdge(e);
            //add edge in my edge sorting set
            this.sortedEdges.add(e);
        }
        this.sortedEdges = EdgeWeightedGraph.EdgeArrayAscendingSort(this.sortedEdges);
    }
    
    public static ArrayList<Edge> EdgeArrayAscendingSort(ArrayList<Edge> edges){
    	Edge[] edgeArray = (Edge[])edges.toArray();
    	QuickX.sort(edgeArray);
    	return (new ArrayList<Edge>(Arrays.asList(edgeArray)));
    }
